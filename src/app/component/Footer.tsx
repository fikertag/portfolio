const Footer = () => {
  return (
    <footer className="relative mt-8 flex flex-col items-center justify-start md:flex-row text-[#2f3e46]">
      <span className="py-2 border px-4 rounded-sm border-zinc-200/80 bg-zinc-300 shadow-[0_3px_2px_rgb(0_0_0/15%)] right-4 top-4 hidden md:absolute md:block self-center p-2">
        Updated : Feb 05 2025
      </span>{" "}
      <h4 className="text-md flex flex-row items-center justify-center gap-2 p-8 text-secondary">
        Made with{" "}
        <svg
